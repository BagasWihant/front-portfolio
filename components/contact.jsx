...
import { CardBorder } from "./ui/moving-border";

const Contact = ({ text }) => {
  return (
    <div className="min-h-screen flex justify-center items-center max-md:mt-7 max-md:w-full max-md:px-2">
      <CardBorder
        duration={5068}
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-9">
          <form className="lg:w-[440px] sm:w-72 " onSubmit={handleSubmit}>
            <h2 className="font-bold text-xl text-center text-neutral-200">
              {text.contact_text_id}
            </h2>
            ...
            <LabelInputContainer className="mb-4">
              ...
              <Input
                id="email"
                placeholder="your_email@wihant.com"
                type="email"
              />
            </LabelInputContainer>
            <LabelInputContainer className="mb-4">
          ...
          <div className="w-full">
            ...
            <div className="card-sosmed md:h-full h-60">
              <div className="background-sosmed"></div>
              <div className="logo-sosmed">Follow my Social Media</div>
